...
export const mentors: Mentor[] = [
  ...
  // 🔥 CORE LEAD MENTORS
  {
    ...
    name: "Chunchun",
    title: "Lead Mentor",
    specialty: "Physics (Kota Experience)",
    experience: 5,
    rating: 4.9,
    reviews: 200,
    image: "/mentors/chunchun.jpeg",
    bio: "Physics mentor with 5+ years of experience including Kota exposure, focused on concept clarity and problem-solving.",
  ...
  //   specialty: "Biology & Medical Concepts",
  //   experience: 8,
  //   rating: 4.9,
  //   reviews: 180,
  //   image: "/mentors/amit.png",
  //   bio: "Radiology professional with 8+ years of experience, helping students understand biology with real-world concepts.",
  ...
  // },
  {
    ...
    bio: "Guides students in making the right career decisions after school with practical insights.",
  ...
  },
  {
    ...
    specialty: "Chemistry & Problem Solving",
    experience: 4,
    rating: 4.8,
    reviews: 110,
    image: "/mentors/lakhan.png",
    bio: "Chemistry mentor with strong problem-solving approach. Achieved 180/180 in Physics.",
    availability: ["Daily"],
    classes: ["Class 11", "Class 12"],
  },
  {
    ...
    title: "Mentor",
    specialty: "Logical Thinking",
    experience: 3,
    rating: 4.9,
    reviews: 120,
    image: "/mentors/dharmveer.jpeg",
    bio: "Mentor focused on logic building and structured thinking.",
    availability: ["Monday", "Wednesday", "Friday"],
    classes: ["Class 10", "Class 11", "Class 12"],
  },
  ...
  // 🎯 SENIOR / STRATEGY
  {
    ...
    bio: "Helps students explore career options with structured guidance.",
  ...
  },
  {
    ...
    bio: "Helps students plan their preparation journey with structured strategies.",
    availability: ["Monday", "Wednesday", "Friday"],
    classes: ["Class 10", "Class 11", "Class 12"],
  },
  {
    ...
    name: "Pritam Meher",
    title: "Mentor",
    specialty: "Academic Strategy",
    experience: 4,
    rating: 4.8,
    reviews: 100,
    image: "/mentors/pritam.png",
    bio: "Focuses on smart preparation and consistency.",
    availability: ["Monday", "Tuesday", "Thursday"],
    classes: ["Class 11", "Class 12"],
  },
  {
    ...
    name: "Rahul Kumar",
    title: "Mentor",
    specialty: "Motivation & Strategy",
    experience: 3,
    rating: 4.7,
    reviews: 90,
    image: "/mentors/rahul.png",
    bio: "Mentor focused on discipline, motivation, and exam strategies.",
    availability: ["Monday", "Wednesday", "Friday"],
    classes: ["Class 11", "Class 12"],
  },
  {
    id: "mentor-11",
    name: "Abhinav Kumar Barik",
    title: "Mentor",
    ...
    bio: "Guides students with practical strategies and smart preparation techniques.",
    availability: ["Monday", "Wednesday", "Friday"],
    classes: ["Class 11", "Class 12"],
  },
  {
    ...
    bio: "Helps students with preparation roadmap and strategy.",
  ...
  // 📘 FOUNDATION + SUBJECT
  {
    ...
    specialty: "Basic Science (Class 1–5)",
    experience: 2,
    rating: 4.8,
    reviews: 40,
    image: "/mentors/jagarnath.png",
    bio: "Builds strong science fundamentals for early learners.",
    availability: ["Monday", "Wednesday", "Friday"],
    classes: ["Class 1-5"],
  },
  {
    ...
    bio: "Helps students solve advanced-level problems with clarity.",
    availability: ["Tuesday", "Thursday", "Saturday"],
    classes: ["Class 6-12"],
  },
  {
    ...
    bio: "Focuses on structured problem-solving.",
    availability: ["Tuesday", "Thursday", "Saturday"],
    classes: ["Class 10", "Class 11", "Class 12"],
  },
  {
    ...
    bio: "Guides students in medical preparation and career path.",
...
export const liveClasses: LiveClass[] = [
  {
    ...
    maxCapacity: 300,
    description:
      'Advanced physics classes for boards, JEE and NEET preparation with Kota-style teaching.',
  },
  {
    id: 'live-2',
    title: 'Biology Master Session',
    ...
    maxCapacity: 250,
    description:
      'Concept-focused biology sessions for NEET aspirants and school students.',
  },
  {
    id: 'live-3',
    ...
    maxCapacity: 250,
    description:
      'Detailed chemistry classes covering theory, numericals and exam-oriented practice.',
  },
  {
    id: 'live-4',
    title: 'Mathematics Foundation Class',
    mentor: 'Rahul Kumar',
    grade: 'Class 10',
    subject: 'Mathematics',
    startTime: 'Tentative Schedule',
    ...
    maxCapacity: 200,
    description:
      'Interactive mathematics classes with shortcut techniques and doubt solving.',
  },
  ...
  // Recorded Classes
  {
    ...
    maxCapacity: -1,
    description:
      'Complete recorded physics lectures with notes and practice questions.',
  },
  {
    id: 'recorded-2',
    ...
    maxCapacity: -1,
    description:
      'Recorded NEET biology lectures with diagrams and revision support.',
  },
];
...
export const courses: Course[] = [
  // Class 1-5
  {
    ...
    rating: 4.7,
    description:
      'Basic science learning program designed for young students with interactive teaching methods.',
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      'Strong mathematical foundation course for junior students.',
    mentor: 'S M Sir',
    features: [
      'Concept Clarity',
      'Practice Sheets',
  ...
  // Class 6-8
  {
    ...
    rating: 4.8,
    description:
      'Comprehensive foundation preparation for science and mathematics.',
    mentor: 'A K Mam',
    features: [
      'Foundation Building',
      'Weekly Practice',
  ...
  // Class 9-10
  {
    ...
    rating: 4.9,
    description:
      'Complete board exam preparation with strong conceptual learning.',
    mentor: 'Dr. Amit Kumar Dubey',
    features: [
      'Board Preparation',
      'Live Classes',
  ...
  // Class 11
  {
    ...
    rating: 4.8,
    description:
      'Complete Class 11 science preparation with competitive foundation.',
    mentor: 'Niraj Kumar',
    features: [
      'JEE/NEET Foundation',
      'Weekly Tests',
  ...
  // Class 12
  {
    ...
    rating: 4.9,
    description:
      'Advanced Class 12 preparation for boards and competitive exams.',
    mentor: 'Chunchun Sir',
    features: [
...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    offerPrice: 1999,
    annualPrice: 19999,
    description: 'Perfect for students from Class 1 to 10',
    features: [
      'All school courses (Class 1–10)',
      'Recorded classes',
      'Weekly doubt sessions',
      'Study material',
      'Community access',
    ],
    classes: ['Class 1-5', 'Class 6-8', 'Class 9-10'],
  },
  {
    id: 'plan-2',
    name: 'Premium',
    ...
    offerPrice: 4999,
    annualPrice: 49999,
    description: 'Best for Class 11, 12 & competitive exams',
    highlighted: true,
    features: [
    ...
    classes: ['Class 11', 'Class 12', 'JEE', 'NEET'],
  },
];
